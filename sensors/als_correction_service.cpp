...
static constexpr auto ALS_RADIUS = 64;
...
void updateScreenBuffer() {
    ...
    if (now.tv_sec - lastScreenUpdate >= SCREENSHOT_INTERVAL) {
        ...
        ScreenshotClient::capture(SurfaceComposerClient::getInternalDisplayToken(),
                                  android::ui::Dataspace::DISPLAY_P3_LINEAR,
                                  android::ui::PixelFormat::RGBA_8888,
                                  Rect(ALS_POS_X - ALS_RADIUS, ALS_POS_Y - ALS_RADIUS, ALS_POS_X + ALS_RADIUS, ALS_POS_Y + ALS_RADIUS),
